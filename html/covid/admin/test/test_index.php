...
<?php  
 ...
 $query = "
 SELECT tbm.co_name, tbd.da_icon,tbd.da_popup,tbd.data_id
      FROM tb_map tbm
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><input type="button" name="view" value="view" id="<?php echo $row["data_id"]; ?>" class="btn btn-info btn-xs view_data" /></td>  
                          </tr>  
                          <?php  
                          }  
                          ?>  
